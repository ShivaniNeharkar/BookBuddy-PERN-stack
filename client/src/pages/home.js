...
const Home = () => {
  ...
  return (
    <Layout>
      <div class="container">
            <h1 style={{textAlign: "center", fontSize: "36px", color: "#333", marginBottom: "30px"}}>Welcome to the Book Buddy</h1>
            <p style={{fontSize: "15px", marginBottom: "10px"}}>Greetings! I'm Shivani, the creator of the Book Buddy. Embark on a journey through this digital library adventure.</p>
